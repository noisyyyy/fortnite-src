...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x + 0, frame_bb.Min.y + 12.5), ImVec2(total_bb.Min.x + 120, total_bb.Min.y + 16.5), GetColorU32(ImGuiCol_FrameBg), 0, 0);

   // window->DrawList->AddRectFilledMultiColorRounded(ImVec2(frame_bb.Min.x - 1, frame_bb.Min.y + 12), ImVec2(frame_bb.Min.x + it_filing->second.value + 8, total_bb.Min.y + 17), ImColor(0.5f, 0.03f, 0.225f, 0.f), ImColor(0.5f, 0.03f, 0.225f, 1.f), ImColor(1.f, 0.06f, 0.55f, 1.f), ImColor(1.f, 0.06f, 0.55f, 1.f), ImColor(0.5f, 0.03f, 0.225f, 1.f),19.f);
    window->DrawList->AddRectFilled(ImVec2(frame_bb.Min.x - 1, frame_bb.Min.y + 12), ImVec2(frame_bb.Min.x + it_filing->second.value + 8, total_bb.Min.y + 17), ImColor(1.f, 1.f, 1.f, 1.f), 10);
    ...
    RenderTextClipped(ImVec2(total_bb.Min.x - w , total_bb.Min.y - 30), ImVec2(total_bb.Min.x + 2, total_bb.Min.y + 56), value_buf, value_buf_end, NULL, ImVec2(0.9f, 0.5f));
